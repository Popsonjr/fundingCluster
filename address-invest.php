...
<div id="section3">
	...
	<div class="row">
 <div class="col-sm-2">
  <a href="addnumber-invest.php?name=<?php echo $name?>"><h5 align="left" id="back" style="font-size: 13px; font-weight: bolder; color: #7A838E; padding-top: 222%;" class="container"><i style="font-size: 32px; margin-right: 10px;" class="fa fa-angle-left" aria-hidden="true"></i><font style="position: relative; top: -5px;">Back</font></h5></a>
  ...
  <div class="col-sm-2"></div>
	...
	<?php
      if (isset($_POST['continue'])) {
      	...
      	if ($query) {
      	echo "<script>window.top.location='residential-status-invest.php?name=$name'</script>";
      	}
