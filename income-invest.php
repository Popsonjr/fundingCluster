...
<div class="row">
   <div class="col-sm-2">
  <a href="risk.php?name=<?php echo $name?>"><h5 align="left" id="back" style="font-size: 13px; color: #7A838E; padding-top: 222%;" class="container"><i style="margin-right: 10px; font-size: 32px;" class="fa fa-angle-left" aria-hidden="true"></i><font style="position: relative;top: -5px;" >Back</font></h5></a>
...
if ($b) {
   ...
   echo "<script>window.top.location='addnumber-invest.php?name=$name';</script>";
