...
<nav class="fixed-top">
  <div class="row" >
    <div class="col-md-5" style="height: 12.5vh; width: 100%; padding-left: 11.5%;"><span class="navbar-brand">
      <img style="position: absolute; top: 40%; transform: translate(-50%, -50%); margin-right: 10%;" src="image/nav-img.png" width="100px">
       <a id="invest" style="font-weight: normal; font-size: 15px;" href="invest.php">Invest</a>
    </span></div>
    <div class="col-md-7" align="right" style=" float: right; padding-right: 140px; padding-left: 150px; padding-bottom: 40px; padding-top: 22px;" >
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
